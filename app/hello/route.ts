export async function GET() {
  const paragraphs = [
    "I'm one of the co-founders of Halvex, a startup that aims to provide affordable cloud infrastructure revolutionary digital solutions to make a positive impact on the world.",
